...
from .model import CoreDataMLBase
...
MODEL_CLASS = CoreDataMLBase


def init_app(model_class):
    global MODEL_CLASS

    if not issubclass(model_class, CoreDataMLBase):
        raise ValueError('Inference class should be the subclass of ' + CoreDataMLBase.__class__.__name__)
