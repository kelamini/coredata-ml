...
from .model import get_all_classes_inherited_CoreDataMLBase
...
def get_args():
    ...
    parser = argparse.ArgumentParser(description='Core Data')
    subparsers = parser.add_subparsers(dest='command', help='Available commands')
    subparsers.required = True

    # init sub-command parser
    parser_init = subparsers.add_parser('init', aliases=['create'], help='Initialize Core Data ML', parents=[root_parser])
    ...
    parser_start = subparsers.add_parser('start', help='Initialize Core Data', parents=[root_parser])
    parser_start.add_argument(
        'project_name',
        help='Path to directory where project state will be initialized')

    # start deploy to gcp
    parser_deploy = subparsers.add_parser('deploy', help='Deploy Core Data', parents=[root_parser])
    ...
    parser_deploy.add_argument(
        ...
        help='GCP region')
    parser_deploy.add_argument(
        '--label-studio-host', dest='label_studio_host', default='',
        help='Core Data hostname')
    parser_deploy.add_argument(
...
def create_dir(args):
    ...
    if model_def_in_path(script_path):
        ...
        model_classes = get_all_classes_inherited_CoreDataMLBase(script_path)
    ...
    print('\n1. Try it out by running:\n' + Fore.CYAN + 'coredata-ml start ' + output_dir + Fore.RESET +
          '\nYou should be able to connect to it in Core Data project Settings > Machine Learning > Add Model '
